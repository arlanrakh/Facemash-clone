...
let totalImages = 10; // Adjust this number based on the actual number of images you have
let ratings = {};
...
function getImage(excludeIds) {
    let candidates = Object.keys(ratings).filter(id => !excludeIds.includes(id));
...
function updateLeaderboard() {
    ...
    let leaderboardHTML = sortedParticipants.map(([id, { rating, src }], index) => {
        return `<li>
